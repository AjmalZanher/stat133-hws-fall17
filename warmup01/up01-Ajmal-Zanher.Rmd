...
This is not my first time using markdown, however, it is my second time. I have to admit that being able to complete the alloted tasks gives the user a great sense of satisfaction and the process is exceptionally smooth.<br>
...
Carefully matching the Math equations with the LaTeX syntax was, by far, the most time consuming aspect of this homework. <br>     